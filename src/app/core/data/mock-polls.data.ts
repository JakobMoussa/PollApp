...
/**
 * A local array of mock polls used as fallback or initial data.
 * This provides sample data for different poll categories and statuses,
 * including questions and options with predefined answer percentages.
 */
